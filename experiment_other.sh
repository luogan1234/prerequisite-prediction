...
echo $cmd & $cmd
for seed in {0..49}; do
  cmd="python main.py -dataset mooczh -model LSTM_S -result_path base.txt -seed $seed"
  echo $cmd & $cmd
done
mv result/result/base.txt result/result/LSTM_S_mooczh.txt
# TextCNN
for dataset in "moocen" "mooczh"; do
  for model in "TextCNN"; do
    ...
    mv result/result/base.txt result/result/${model}_${dataset}.txt
  done
done
# GCN moocen alpha
for alpha in 0.1 0.3 0.5 0.7 0.9; do
  ...
  echo $cmd & $cmd
  for seed in {0..49}; do
    cmd="python main.py -dataset moocen -model GCN -result_path alpha.txt -seed $seed"
    echo $cmd & $cmd
  done
  mv result/result/alpha.txt result/result/GCN_moocen_alpha${alpha}_v.txt
done
# GCN moocen feature
...
for feature_dim in 4 8 16 24 32; do
  for seed in {0..49}; do
    cmd="python main.py -dataset moocen -model GCN -feature_dim $feature_dim -result_path feature.txt -seed $seed"
    echo $cmd & $cmd
  done
  mv result/result/feature.txt result/result/GCN_moocen_dim${feature_dim}_v.txt
done
# GCN mooczh alpha
for alpha in 0.1 0.3 0.5 0.7 0.9; do
  ...
  echo $cmd & $cmd
  for seed in {0..49}; do
    cmd="python main.py -dataset mooczh -model GCN -result_path alpha.txt -seed $seed"
    echo $cmd & $cmd
  done
  mv result/result/alpha.txt result/result/GCN_mooczh_alpha${alpha}_cv.txt
  ...
  mv result/result/alpha.txt result/result/GCN_mooczh_alpha${alpha}_s.txt
  ...
  mv result/result/alpha.txt result/result/GCN_mooczh_alpha${alpha}_cvs.txt
done
# GCN mooczh feature
...
for feature_dim in 4 8 16 24 32; do
  for seed in {0..49}; do
    cmd="python main.py -dataset mooczh -model GCN -feature_dim $feature_dim -result_path feature.txt -seed $seed"
    echo $cmd & $cmd
  done
  mv result/result/feature.txt result/result/GCN_mooczh_dim${feature_dim}_cv.txt
done
...
for feature_dim in 4 8 16 24 32; do
  ...
  mv result/result/feature.txt result/result/GCN_mooczh_dim${feature_dim}_s.txt
done
cmd="python build_graph.py -dataset mooczh"
echo $cmd & $cmd
for feature_dim in 4 8 16 24 32; do
  ...
  mv result/result/feature.txt result/result/GCN_mooczh_dim${feature_dim}_cvs.txt
done
...
for user_act_type in "none" "sequential_only" "cross_course_only" "backward_only" "no_sequential" "no_cross_course" "no_backward" "no_skip"; do
  ...
  mv result/result/user.txt result/result/GCN_mooczh_user_act_type_${user_act_type}_cvs.txt
done
...
for user_num in 0 25 50 100 250 500; do
  ...
  mv result/result/user.txt result/result/GCN_mooczh_user_num${user_num}_s.txt
done
for user_prop in 0.1 0.2 0.4 0.7 1.0; do
  ...
  mv result/result/user.txt result/result/GCN_mooczh_user_prop${user_prop}_s.txt
done
: '
# gcn no weight
...
mv result/result/no_weight.txt result/result/GCN_moocen_v_nw.txt
...
mv result/result/no_weight.txt result/result/GCN_mooczh_cv_nw.txt
...
mv result/result/no_weight.txt result/result/GCN_mooczh_s_nw.txt
...
mv result/result/no_weight.txt result/result/GCN_mooczh_cvs_nw.txt
'