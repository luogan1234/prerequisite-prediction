...
class GCN_LSTM(BaseModel):
    def __init__(self, config):
        ...
        self.fc = nn.Linear(config.gcn_hidden*2+config.lstm_hidden*4+config.feature_dim, config.num_classes)

    def forward(self, inputs):
        x1, x2, x3, x4, features = inputs
        ...
        o = torch.cat([o1, o2, o3, o4, features], -1)
        out = self.fc(o)
        return out